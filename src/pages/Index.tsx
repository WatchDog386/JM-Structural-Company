          ...
          <div className="w-full relative pt-0 pl-2 md:pl-0">
            ...
            >
              <h1 className="text-3xl md:text-4xl lg:text-[3.25rem] font-bold leading-[1.3] lg:leading-[1.4] mb-6 text-white font-heading tracking-tight drop-shadow-lg">
                ...
                <span className="block mt-1 text-xl md:text-2xl lg:text-3xl font-medium text-[#FF6B00]">JM LEADS THE WAY !</span>
              </h1>
              ...
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center min-w-[140px] h-12 bg-gradient-to-r from-[#22C55E] to-[#16A34A] text-white rounded font-semibold transition-all shadow-lg hover:shadow-xl hover:translate-y-[-2px] text-xs uppercase tracking-widest"
              >
                Contact us
              </Link>
            </motion.div>
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
              {/* Card 1 */}
              <div className="group relative overflow-hidden rounded-lg bg-[#145a7a] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl h-[280px] lg:h-[300px]">
                 ...
                 <div className="relative z-10 p-8 h-full flex flex-col items-center justify-center text-center">
                    <div className="w-14 h-14 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center mb-6 text-white group-hover:bg-white group-hover:text-[#0E4861] transition-all shadow-inner">
                      <Check className="w-7 h-7" strokeWidth={3} />
                    </div>
                    <h4 className="text-white text-lg font-bold mb-3 drop-shadow-md">Flexible time</h4>
                    <p className="text-blue-50 text-sm leading-relaxed px-4 drop-shadow-sm font-medium">
              ...
              <div className="group relative overflow-hidden rounded-lg bg-[#145a7a] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl h-[280px] lg:h-[300px]">
                 ...
                 <div className="relative z-10 p-8 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="text-white text-lg font-bold mb-3 drop-shadow-md">Customizable design</h4>
                    <p className="text-blue-50 text-sm leading-relaxed px-4 drop-shadow-sm font-medium">
              ...
              <div className="group relative overflow-hidden rounded-lg bg-[#145a7a] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl h-[280px] lg:h-[300px]">
                 ...
                 <div className="relative z-10 p-8 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="text-white text-lg font-bold mb-3 drop-shadow-md">Negotiable price</h4>
                    <p className="text-blue-50 text-sm leading-relaxed px-4 drop-shadow-sm font-medium">
