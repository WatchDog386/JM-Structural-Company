...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <section className="relative w-full h-[280px] md:h-[380px] lg:h-[640px] overflow-hidden bg-white">
        
        {/* White Header Top Strip Background */}
        <div className="absolute top-0 right-0 w-full h-12 bg-white z-0"></div>
        ...
        {/* BLUE DIAGONAL OVERLAY - Hidden on mobile */}
        <div 
        ...
        {/* NAVBAR */}
        <nav className="absolute top-0 left-0 w-full z-30 flex items-center h-14">
           <div className="w-full px-3 md:px-6 flex justify-between items-center h-full">
              {/* Logo */}
              <div className="z-50 flex flex-col items-start">
                <h1 className="text-[#0E4861] md:text-white text-2xl md:text-3xl font-black tracking-tighter leading-none font-heading">
                  JM
                </h1>
              </div>

              {/* Navigation Links */}
              <div className="hidden md:flex gap-4 lg:gap-6 items-center z-50 pr-1 absolute md:left-[75%] lg:left-[71%] transform -translate-x-1/2">
                 <Link to="/" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading">Home</Link>
                 <Link to="/about" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading">About</Link>
                 <Link to="/services" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading">Services</Link>
                 <Link to="/projects" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading">Projects</Link>
                 <Link to="/contact" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading">Contact</Link>
                 <Link to="/contact" className="text-[#0E4861] font-semibold text-[10px] lg:text-sm hover:text-[#008fb3] transition-colors font-heading whitespace-nowrap">Get a Quote</Link>
              </div>

               {/* Mobile Menu Toggle */}
               <div 
                  className="md:hidden z-50 text-[#0E4861] bg-white p-1.5 rounded shadow-sm cursor-pointer mr-3"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="fixed top-14 right-0 w-3/4 bg-white z-40 shadow-xl border-l border-gray-100 overflow-hidden"
            >
              <div className="flex flex-col p-4 gap-3 items-center">
                 <Link to="/" onClick={() => setIsOpen(false)} className="font-semibold text-sm text-[#0E4861] hover:text-[#008fb3]">Home</Link>
                 <Link to="/about" onClick={() => setIsOpen(false)} className="font-semibold text-sm text-[#0E4861] hover:text-[#008fb3]">About</Link>
                 <Link to="/services" onClick={() => setIsOpen(false)} className="font-semibold text-sm text-[#0E4861] hover:text-[#008fb3]">Services</Link>
                 <Link to="/projects" onClick={() => setIsOpen(false)} className="font-semibold text-sm text-[#0E4861] hover:text-[#008fb3]">Projects</Link>
                 <Link to="/contact" onClick={() => setIsOpen(false)} className="font-semibold text-sm text-[#0E4861] hover:text-[#008fb3]">Contact</Link>
                 <Link to="/contact" onClick={() => setIsOpen(false)} className="mt-2 px-5 py-2 bg-[#008fb3] text-white font-semibold rounded-xl shadow-md uppercase tracking-wide text-xs">
                   Get a Quote
                 </Link>
              </div>
            </motion.div>
        ...
        <div className="container relative h-full mx-auto px-3 z-20 flex items-center justify-center md:justify-start">
          <div className="w-full relative pt-0 pl-2 md:pl-0 text-center md:text-left">
            <motion.div
              ...
              className="max-w-[600px] lg:max-w-[800px] mx-auto md:mx-0"
            >
              <h1 className="text-base md:text-xl lg:text-5xl font-black leading-[1.3] lg:leading-[1.2] mb-2 md:mb-4 font-heading tracking-tight drop-shadow-sm pt-16 md:pt-0">
              ...
              <div className="hidden md:block text-[#D65828] text-xl md:text-3xl lg:text-5xl mb-3 tracking-wide" style={{ fontFamily: '"Dancing Script", cursive' }}>
                JM Leads The Way!
              </div>

              <div className="flex flex-row gap-2 md:gap-3 justify-center md:justify-start pt-2 md:pt-0">
                <Link 
                  to="/projects"  
                  className="inline-flex items-center justify-center px-3 py-1.5 md:px-5 md:py-2 bg-[#4CAF50] hover:bg-[#43a047] text-white rounded-full font-semibold text-[10px] md:text-xs lg:text-sm uppercase tracking-wide shadow-md transition-transform hover:scale-105"
                >
                  <span className="bg-white/20 rounded-full p-0.5 mr-1.5 md:mr-2">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" className="ml-0 w-2.5 h-2.5 md:w-3 md:h-3">
                ...
                <Link 
                  to="/contact"  
                  className="inline-flex items-center justify-center px-3 py-1.5 md:px-5 md:py-2 bg-white text-[#0E4861] hover:bg-gray-50 rounded-full font-semibold text-[10px] md:text-xs lg:text-sm uppercase tracking-wide shadow-md transition-transform hover:scale-105 border border-transparent"
                >
                  Contact Us
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="ml-1 w-3 h-3 md:w-3.5 md:h-3.5">
          ...
          <div className="hidden lg:flex absolute bottom-4 right-4 z-10 gap-3">
             <motion.div 
               initial={{ y: 50, opacity: 0 }}
               animate={{ y: 0, opacity: 1 }}
               transition={{ delay: 0.5, duration: 0.8 }}
               className="w-32 h-24 shadow-lg"
             >
      ...
      <section className="py-10 md:py-14 bg-white overflow-hidden">
        <div className="container mx-auto px-3">
          <div className="flex flex-row gap-3 md:gap-6 lg:gap-8 items-start justify-center">
            
            {/* Left Image Grid */}
            <div className="w-1/2 lg:w-[45%] relative max-w-[350px] lg:max-w-[400px] flex-shrink-0">
               <div className="grid grid-cols-2 gap-0.5 md:gap-1.5 rounded-2xl overflow-hidden">
               ...
               <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 w-[28%] aspect-square">
                 <div className="w-full h-full bg-white rounded-full shadow-lg flex flex-col items-center justify-center border-2 border-white">
                    <Check className="w-[40%] h-[40%] text-[#0E4861] stroke-[4]" />
                    <span className="text-[8px] md:text-[9px] lg:text-[10px] font-semibold text-[#0E4861] leading-none mt-1">Pro licensed</span>
                 </div>
               </div>
            </div>

            {/* Right Text Content */}
            <div className="w-1/2 lg:w-1/2 lg:pl-6">
              <h2 className="text-[#0E4861] font-semibold text-sm md:text-base mb-2 font-heading">Our company</h2>
              <p className="text-gray-500 mb-4 md:mb-6 leading-relaxed text-[10px] md:text-xs font-normal text-justify">
              ...
              <p className="text-[#0E4861] font-medium mb-3 text-[10px] md:text-xs">
                We have successfully delivered
              </p>

              <div className="flex gap-3 md:gap-8 mb-4 md:mb-6 flex-wrap">
                {stats.map((stat, i) => (
                  <div key={i} className="flex flex-col">
                    <h3 className="text-[#008fb3] text-sm md:text-base font-semibold mb-0.5">{stat.value}</h3>
                    <p className="text-[#0E4861] text-[10px] md:text-xs font-semibold">{stat.label}</p>
                  </div>
                ))}
              </div>
              ...
              <Link 
                to="/about" 
                className="inline-flex items-center px-4 md:px-6 py-1.5 md:py-2 bg-[#008fb3] text-white font-medium hover:bg-[#007a99] transition-colors text-[10px] md:text-xs shadow-md rounded-lg"
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-3">
          <div className="text-center mb-4">
             <h2 className="text-[#0E4861] font-semibold text-lg md:text-xl mb-1 font-heading">Our services</h2>
             <p className="text-gray-500 text-[10px] max-w-xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
             {services.map((service, index) => (
                <div 
                  key={service.id} 
                  className={`p-4 transition-all duration-300 group relative flex flex-col justify-start rounded-md ${
                     service.highlight 
                ...
                >
                  ...
                  <div className={`relative z-10 mb-3 ${service.highlight ? "text-white" : "text-[#333]"}`}>
                    {service.title === "Renovation" ? (
                       <div className="relative w-6 h-6">
                          <Hammer className="absolute top-0 left-0 w-4 h-4 transform rotate-12" strokeWidth={2} />
                          <Wrench className="absolute bottom-0 right-0 w-4 h-4 transform -rotate-[100deg] translate-x-1" strokeWidth={2} />
                       </div>
                    ) : (
                       <service.icon size={24} strokeWidth={service.highlight ? 1.5 : 2} />
                    )}
                  </div>
                  
                  <h4 className={`relative z-10 text-xs font-semibold mb-1 ${service.highlight ? "text-white" : "text-[#333]"}`}>
                    {service.title}
                  </h4>
                  <p className={`relative z-10 text-[9px] leading-relaxed ${service.highlight ? "text-white/80" : "text-gray-500"}`}>
                    {service.description}
                  </p>
                </div>
             ))}
      ...
      {/* Benefits Section */}
      <section className="bg-white py-8 md:py-10 relative overflow-hidden">
        <div className="container mx-auto px-3 relative z-10">
           {/* Benefits Header */}
           <div className="text-center mb-6 md:mb-8">
              <h3 className="text-[#00A3CC] font-semibold text-[10px] md:text-xs mb-1 uppercase tracking-wider">Our benefits</h3>
              <h2 className="text-[#0E4861] text-base md:text-lg lg:text-xl font-semibold max-w-2xl mx-auto leading-tight">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-10 md:mb-12">
              {/* Card 1 */}
              <div className="group relative overflow-hidden rounded-md bg-[#145a7a] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-[180px] md:h-[200px]">
                 ...
                 <div className="relative z-10 p-4 h-full flex flex-col items-center justify-center text-center">
                    <div className="w-8 h-8 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center mb-2 text-white group-hover:bg-white group-hover:text-[#0E4861] transition-all shadow-inner">
                      <Check className="w-4 h-4" strokeWidth={3} />
                    </div>
                    <h4 className="text-white text-sm md:text-base font-semibold mb-1 drop-shadow-md">Flexible time</h4>
                    <p className="text-blue-50 text-[9px] md:text-[10px] leading-relaxed px-1 drop-shadow-sm font-medium">
              ...
              <div className="group relative overflow-hidden rounded-md bg-[#145a7a] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-[180px] md:h-[200px]">
                 ...
                 <div className="relative z-10 p-4 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="text-white text-sm md:text-base font-semibold mb-1 drop-shadow-md">Customizable design</h4>
                    <p className="text-blue-50 text-[9px] md:text-[10px] leading-relaxed px-1 drop-shadow-sm font-medium">
              ...
              <div className="group relative overflow-hidden rounded-md bg-[#145a7a] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-[180px] md:h-[200px]">
                 ...
                 <div className="relative z-10 p-4 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="text-white text-sm md:text-base font-semibold mb-1 drop-shadow-md">Negotiable price</h4>
                    <p className="text-blue-50 text-[9px] md:text-[10px] leading-relaxed px-1 drop-shadow-sm font-medium">
           ...
           {/* Our Works Section */}
           <div className="text-center mb-10 pt-6 border-t border-gray-100">
              <h3 className="text-[#0E4861] font-semibold text-lg md:text-xl mb-2 mt-6">Our works</h3>
              <p className="text-gray-500 text-[10px] max-w-xl mx-auto leading-relaxed">
           ...
           {/* Works Grid */}
           <div className="grid grid-cols-2 md:grid-cols-4 grid-rows-2 gap-3 h-[240px] md:h-[260px] mb-8 max-w-4xl mx-auto">
              <div className="col-span-1 row-span-1 overflow-hidden rounded-2xl group relative cursor-pointer shadow-md">
              ...
              <div className="col-span-1 row-span-2 overflow-hidden rounded-2xl group relative cursor-pointer bg-white shadow-md">
              ...
              <div className="col-span-2 row-span-1 overflow-hidden rounded-2xl group relative cursor-pointer shadow-md">
              ...
              <div className="col-span-1 row-span-1 overflow-hidden rounded-2xl group relative cursor-pointer bg-white shadow-md">
           ...
           <div className="text-center pb-2">
              <Link 
                to="/projects" 
                className="inline-flex items-center justify-center px-6 py-2 border border-[#0E4861]/30 text-[#0E4861] font-semibold text-[10px] rounded transition-all hover:bg-[#0E4861] hover:text-white"
              >
                See more works
              </Link>
           </div>
      ...
      <section className="bg-white py-6 md:py-8 pb-10 md:pb-12 overflow-visible">
          <div className="container mx-auto px-3">
             <div className="flex flex-col lg:flex-row items-center">
                
                {/* Left Side - Text */}
                <div className="w-full lg:w-[35%] z-10 mb-4 md:mb-6 lg:mb-0 lg:pr-6">
                   <h2 className="text-[#0E4861] text-base md:text-lg font-semibold mb-2 font-heading tracking-tight">What our clients say?</h2>
                   <p className="text-gray-500 text-[10px] md:text-xs mb-4 leading-relaxed font-medium">
                     See what our clients say <br /> about their new home
                   </p>
                    <Link 
                        to="/testimonials" 
                        className="inline-flex items-center justify-center px-4 py-1.5 bg-[#00A3CC] text-white font-semibold text-[10px] md:text-xs shadow-sm hover:bg-[#008fb3] hover:shadow-md transition-all rounded-sm"
                    >
                        See more
                    </Link>
                </div>
                ...
                <div className="w-full lg:w-[65%] relative">
                   ...
                   <div className="absolute -bottom-6 md:-bottom-8 right-0 lg:-right-4 w-[90%] md:w-[75%] lg:w-[65%] bg-[#0E4861] p-3 md:p-4 shadow-lg rounded-sm z-20">
                         {/* Circle Avatar */}
                         <div className="absolute -top-5 md:-top-6 left-4 w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-white overflow-hidden shadow-sm bg-gray-200">
                            <img src="https://i.pravatar.cc/150?img=60    " alt="Client" className="w-full h-full object-cover" />
                         </div>

                         <div className="mt-3">
                             <p className="text-white text-[9px] md:text-[10px] italic leading-4 md:leading-5 mb-2 font-light">
                             ...
                             <p className="text-white font-semibold text-[10px] md:text-xs tracking-wide">
                               - Mr. Roberto
                             </p>
                         </div>
                   </div>
