        ...
        <div className="container mx-auto px-3 text-center">
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/15 border border-primary/20 mb-3">
              ...
              <span className="text-[8px] md:text-[9px] text-primary font-medium tracking-wide uppercase">Our Portfolio</span>
            </div>
            <h1 className="text-base md:text-lg lg:text-xl font-heading font-bold text-secondary mb-1.5">Our Projects</h1>
            <p className="text-muted-foreground text-[9px] md:text-[10px] max-w-md mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-1.5 md:gap-2 mb-6 md:mb-8">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3 py-1 rounded text-[9px] md:text-[10px] font-bold transition-all ${
                  activeCategory === cat
