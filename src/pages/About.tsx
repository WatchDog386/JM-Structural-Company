...
const About = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="relative w-full h-[60vh] min-h-[400px] flex items-center justify-center bg-[#0E4861] overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/20 mb-6 shadow-2xl">
              <div className="w-1.5 h-1.5 rounded-full bg-[#00A3CC] animate-pulse"></div>
              <span className="text-[10px] text-white font-bold tracking-[0.2em] uppercase">Est. 2010</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-bold text-white mb-6 font-heading tracking-tight leading-[0.9]">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#00A3CC]/80">Us</span>
            </h1>
            
            <p className="text-blue-50/90 text-sm md:text-lg font-light max-w-3xl mx-auto leading-relaxed border-t border-white/10 pt-6 mt-4">
            ...
            <div className="mt-6 flex flex-col items-center gap-2">
              <p className="text-white font-semibold text-xs md:text-sm">JM Leads The Way!</p>
              <p className="text-[#FFD700] font-bold text-xs md:text-base">We depend on God</p>
            </div>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-row gap-4 md:gap-8 lg:gap-16 items-center">
            ...
            <div className="w-1/3 lg:w-5/12 flex justify-center lg:justify-start relative pl-2 md:pl-4 pt-4 shrink-0">
              ...
              >
                 ...
                 <div className="absolute top-0 left-0 w-2/3 h-full bg-[#16a34a] rounded-tl-[30px] md:rounded-tl-[50px] rounded-br-[8px] md:rounded-br-[15px] -z-10 -translate-x-2 md:-translate-x-4 -translate-y-2 md:-translate-y-4"></div>
                 <div className="absolute bottom-[-10px] md:bottom-[-20px] right-[-10px] md:right-[-20px] w-16 md:w-24 h-16 md:h-24 bg-[radial-gradient(circle,_#00A3CC_2px,_transparent_2.5px)] bg-[size:8px_8px] md:bg-[size:12px_12px] opacity-40 z-0"></div>

                 {/* Main Image Container - Asymmetric Curve */}
                 <div className="relative overflow-hidden shadow-xl md:shadow-2xl group w-full rounded-tr-[30px] md:rounded-tr-[60px] rounded-bl-[30px] md:rounded-bl-[60px] border-2 md:border-4 border-white bg-white">
                    <img 
                      src="https://scontent-mba2-1.xx.fbcdn.net/v/t39.30808-6/486681197_2451870551836740_2277915400451678782_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=13d280&_nc_eui2=AeHUTsSpq67aCKX8gi5O3YYtxUIQQXcdSMvFQhBBdx1Iy2C69_3h3BcNHJi0IuOSz-BW0UDGrX1stz254E-xHBzR&_nc_ohc=r1zAmgEr2KoQ7kNvwG1q48j&_nc_oc=AdnF4kue3vsHBmCbPYaKGPVuD_fE6i1E1D0Uj527MPiXta01h420PodnNvMksfzectQ&_nc_zt=23&_nc_ht=scontent-mba2-1.xx&_nc_gid=Hj_YDpl9lg-pfZGJNHhLXw&oh=00_Afsk7nIqPHUQdp0EI93qPkkUwBRpnUXqs6O3qphofW8nOw&oe=699AD97A" 
                    ...
                    {/* Corner Accent */}
                    <div className="absolute bottom-0 left-0 w-10 md:w-16 h-10 md:h-16 bg-gradient-to-tr from-[#0E4861] to-transparent opacity-90"></div>
                 </div>

                 {/* Floating Badge - Overlapping - Hidden on mobile, shown on larger screens if needed, or scaled down */}
                 <div className="hidden md:block absolute top-1/2 -right-6 transform -translate-y-1/2 md:translate-x-0 z-20 bg-white p-3 shadow-xl rounded-lg border-l-4 border-[#00A3CC] max-w-[120px]">
                    <div className="flex flex-col">
                       <span className="text-3xl font-bold text-[#0E4861] tracking-tighter">15+</span>
                       <span className="text-[9px] text-gray-400 uppercase tracking-widest font-bold mt-1">Years of<br/>Excellence</span>
                    </div>
                 </div>
              </motion.div>
            </div>
            ...
            <div className="w-2/3 lg:w-1/2 lg:pl-12">
              ...
              >
                <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                   <div className="h-[2px] w-6 md:w-8 bg-gradient-to-r from-[#00A3CC] to-transparent"></div>
                   <span className="text-[#00A3CC] font-bold text-[9px] md:text-[10px] uppercase tracking-[0.2em]">Our Story</span>
                </div>
                
                <h2 className="text-lg md:text-2xl lg:text-3xl font-bold text-[#0E4861] mb-2 md:mb-4 font-heading leading-[1.1]">
                ...
                <p className="text-gray-600 text-[10px] md:text-xs lg:text-sm leading-relaxed mb-4 md:mb-6 font-light text-justify md:text-left">
                ...
                <p className="hidden md:block text-gray-600 text-xs md:text-sm leading-relaxed mb-6 font-light text-justify md:text-left border-l-4 border-[#0E4861]/20 pl-6 italic">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 border-t border-gray-100 pt-4 md:pt-6">
                   <div>
                      <h4 className="text-base md:text-xl font-bold text-[#0E4861] mb-0.5">150+</h4>
                      <p className="text-[9px] md:text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Projects</p>
                   </div>
                   <div>
                      <h4 className="text-base md:text-xl font-bold text-[#0E4861] mb-0.5">98%</h4>
                      <p className="text-[9px] md:text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Satisfaction</p>
                   </div>
                   <div className="hidden md:block">
                      <h4 className="text-base md:text-xl font-bold text-[#0E4861] mb-0.5">30+</h4>
                      <p className="text-[9px] md:text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Awards</p>
                   </div>
                </div>
              </motion.div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-4 lg:gap-6 max-w-4xl mx-auto">
            ...
            >
               ...
               <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-[#0E4861]/5 flex items-center justify-center mb-3 text-[#0E4861] group-hover:bg-[#0E4861] group-hover:text-white transition-colors duration-300">
                  <Target size={18} strokeWidth={2} />
               </div>
               <h3 className="text-lg md:text-xl font-bold text-[#0E4861] mb-2 font-heading tracking-tight">Our Mission</h3>
               <p className="text-gray-600 text-[10px] md:text-xs leading-relaxed font-light">
            ...
            >
               ...
               <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-[#00A3CC]/5 flex items-center justify-center mb-3 text-[#00A3CC] group-hover:bg-[#00A3CC] group-hover:text-white transition-colors duration-300">
                  <Eye size={18} strokeWidth={2} />
               </div>
               <h3 className="text-lg md:text-xl font-bold text-[#0E4861] mb-2 font-heading tracking-tight">Our Vision</h3>
               <p className="text-gray-600 text-[10px] md:text-xs leading-relaxed font-light">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-8 md:mb-12 max-w-xl mx-auto">
            <motion.div
               ...
               transition={{ duration: 0.5 }}
            >
               <span className="text-[#00A3CC] font-bold text-[9px] md:text-[10px] uppercase tracking-[0.2em] mb-2 block">Our Principles</span>
               <h2 className="text-[#0E4861] font-bold text-xl md:text-2xl mb-3 font-heading tracking-tight">Core Values</h2>
               <p className="text-gray-500 text-[10px] md:text-xs font-light leading-relaxed">The foundational principles that guide everything we do at JM Structural.</p>
            </motion.div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5 max-w-5xl mx-auto">
            {values.map((v, i) => (
              ...
              >
                ...
                <h3 className="relative z-10 text-sm md:text-base font-bold text-[#0E4861] mb-2 font-heading group-hover:translate-x-1 transition-transform">{v.title}</h3>
                <p className="relative z-10 text-[9px] md:text-[10px] text-gray-500 leading-relaxed font-light group-hover:text-gray-600">{v.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
